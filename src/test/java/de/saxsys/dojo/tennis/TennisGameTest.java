...
public class TennisGameTest {
	...
	@Test
	public void getScore_returnsP2WinsAfterP2ScoresInOwnAdvantage()
			throws Exception {
		TennisGame game = gameBetweenP1AndP2();
		playUntilDeuce(game);
		game.player2Scores();
	...
	@Test
	public void getScore_returnsDeuceAfterP1ScoresInAdvantageOfP2()
			throws Exception {
		TennisGame game = gameBetweenP1AndP2();
		playUntilDeuce(game);
		game.player2Scores();
	...
	@Test
	public void getScore_returnsAdvantageP1AfterP1ScoresInSecondDeuce()
			throws Exception {
		TennisGame game = gameBetweenP1AndP2();
		playUntilDeuce(game);
		game.player2Scores();
	...
	@Test
	public void getScore_returnsP1WinsAfterP1ScoresInSecondOwnAdvantage()
			throws Exception {
		TennisGame game = gameBetweenP1AndP2();
		playUntilDeuce(game);
		game.player2Scores();
